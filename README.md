...
b. when clicked will call the following service end-points in the following way:
call
...
```
3. Upon completion of this chain show an overlay that contains the result of multiplying val3
by val5.
